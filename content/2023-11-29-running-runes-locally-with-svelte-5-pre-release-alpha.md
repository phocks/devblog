...
In Svelte 5 there's [a new way](https://svelte.dev/docs/svelte/v5-migration-guide) of mounting the app. So you'll have to edit `main.ts` to look a bit like this:

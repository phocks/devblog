...
And now I can't even get it to build at all with the current version. Zola keeps giving me syntax errors. Strangely different errors for local builds to CI builds too. So who knows? I do know that I don't need this.
